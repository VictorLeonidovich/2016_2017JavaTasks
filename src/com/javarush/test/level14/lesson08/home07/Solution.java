...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for(Apartament apartaments1 : apartaments)
        {
            if (apartaments1 instanceof Apt1Room)
            {
                ((Apt1Room) apartaments1).clean1Room();
            }
            if (apartaments1 instanceof Apt2Room)
            {
                ((Apt2Room) apartaments1).clean2Rooms();
            }
            if (apartaments1 instanceof Apt3Room)
            {
                ((Apt3Room) apartaments1).clean3Rooms();
            }
        }
    }
