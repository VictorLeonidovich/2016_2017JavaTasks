...
Horse horse;
        for (int i = 0; i < horses.size(); i++)
        {
            ...
            if (!horse.isFinished()){System.out.println("Waiting for " + horse.getName()); horse.join();}
            if (horse.isFinished()){countFinished += 1; horses.set(i, null);
                /*System.out.println("Horse number" + horse.getName() + "is finished.");*/}
